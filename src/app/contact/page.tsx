      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Have questions about PaperAI? We're here to help. Fill out the form below and we'll get back to you as soon as possible.
          </p>
        </div>
          ...
          <div className="lg:pl-8">
            ...
            <dl className="mt-6 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd><a className="hover:text-gray-900" href="tel:+82-2-1234-5678">+82-2-1234-5678</a></dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd><a className="hover:text-gray-900" href="mailto:contact@paperai.com">contact@paperai.com</a></dd>
              </div>
            </dl>
          </div>
        </div>
